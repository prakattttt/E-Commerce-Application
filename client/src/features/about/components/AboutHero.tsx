...
const AboutHero = () => {
  return (
    <section className="relative overflow-hidden rounded-4xl bg-linear-to-br from-primary via-primary/90 to-secondary-foreground px-6 py-14 text-primary-foreground sm:px-10 lg:px-20">
      {/* Background Blobs */}
